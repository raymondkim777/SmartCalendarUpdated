        ...
        <section className="relative bg-stone-50 py-4 w-full max-w-7xl">
            <div className="w-full mx-auto px-6 lg:px-8 overflow-x-auto">
...

                {
                    ...
                    tileClassName={"flex flex-col h-24 items-center py-2 border-r border-t border-gray-200 text-sm font-semibold text-gray-400 duration-300 transition-all hover:bg-stone-200 active:bg-stone-300"}
